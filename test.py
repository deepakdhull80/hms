...
from common.data_v2 import Datasetv2
...
if __name__ == "__main__":
    ...
    df = preprocess_data(df, ConfigV1)
    ds = Datasetv2(df, ConfigV1)
    row = next(iter(ds))
    print(row)
    ...
    # out2 = classifier(x, y)
    # print(out2)
    # torch.jit.save(torch.jit.trace(classifier, (x,y)), "checkpoints/model.pt")
    # classifier.eval()
